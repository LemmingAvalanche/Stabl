...
wordDef =  (string  def *> whitespace1)
           *> liftA2 (,)
           (word' <* whitespace1) 
           definitionBody -- NOTE: eg skulle gjerne ha lagt til <|> stabl, altså at ein Def kan bestå av eit namn og ein quotation ELLER eit namn og ein stablToken
